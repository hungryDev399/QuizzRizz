...
export default function Quiz({instructor, quizID, levelOfDifficulty, questionsNumber}) {
	const [signed, setSignedState] = useAtom(signedAtom);

	return (
		<Link to={`./${quizID}${signed.userType=="student" ? ('?i='+instructor):''}`} className="ms-14 text-white text-2xl font-medium leading-8 my-auto">
